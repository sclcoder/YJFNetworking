...
FOUNDATION_EXPORT NSString *const YJFRequestCacheErrorDomain;

NS_ENUM(NSInteger) {
    YJFRequestCacheErrorExpired = -1,
    YJFRequestCacheErrorVersionMismatch = -2,
    YJFRequestCacheErrorSensitiveDataMismatch = -3,
    YJFRequestCacheErrorAppVersionMismatch = -4,
    YJFRequestCacheErrorInvalidCacheTime = -5,
    YJFRequestCacheErrorInvalidMetadata = -6,
    YJFRequestCacheErrorInvalidCacheData = -7,
};

///  YJFRequest is the base class you should inherit to create your own request class.
///  Based on YJFBaseRequest, YTKRequest adds local caching feature. Note download
...
@interface YJFCacheableRequest : YJFBaseRequest
